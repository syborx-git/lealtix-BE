...
public class TenantMenuProduct {
    ...
    /** true = Sub-receta (preparación no vendida individualmente, ej. salsas).
     * Tiene sus propios insumos y puede asignarse a platillos o bebidas para
     * que su stock se descuente/considere junto al de ellos. */
    @Builder.Default
